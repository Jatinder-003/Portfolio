...
function Project({ theme, title, description, technologies, github }) {
  return (
    <div className="hover:bg-gray-50 hover:dark:bg-[#101e38] transition-all duration-300 p-6 md:rounded-xl">
        ...
        <div className="flex gap-6 text-gray-500 dark:text-gray-300 font-medium">
            ...
            <a className="flex gap-2 mt-4 hover:text-blue-800 cursor-pointer transition-all duration-300">
                <CiLink className="text-4xl self-center" />
                <a href={github} className="text-2xl self-center">View Github</a>
            </a>
            </div>
    </div>
  )
